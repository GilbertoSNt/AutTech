...
import org.gsnt.auttech.veiculo.CadVeiculoController;
import org.gsnt.auttech.veiculo.Veiculo;
...
public class CriaOsController implements Initializable {
    ...
    private Orcamento.OrcamentoDao orcamentoService = DaoFactory.createOrcamentoDao();
