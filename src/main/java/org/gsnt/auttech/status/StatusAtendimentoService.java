...
public class StatusAtendimentoService implements StatusAtendimentoDao {
    ...
    public Boolean statusOnLineInicial(StatusAtendimento st, OrdemServico os, String cliente) {
        ...
        try {
            ...
            stExt.setString(1, SessionUser.getId());
...
/*  cod bigint NOT NULL DEFAULT nextval('sqtstgrlpblc'::regclass),
    ...
    /*
    @Override
    public void editOrCaixa(Integer codOs, Integer prof, Integer situacao) {
    ...
    @Override
    public void editOrCaixa(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrEletrico(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrInjecao(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrMecanico(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrMontagem(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrMotor(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrPneus(Integer codOs, Integer situacao) {

    }

    @Override
    public void editOrStCliente(Integer codOs, Integer situacao) {

    }

    @Override
    public void editStAlinBalan(Integer codOs, Integer situacao) {

    }

    @Override
    public void editAssLevar(Integer codOs, Integer situacao) {

    }

    @Override
    public void edirCaixa(Integer codOs, Integer situacao) {

    }

    @Override
    public void editEletrico(Integer codOs, Integer situacao) {

    }

    @Override
    public void editFreioDt(Integer codOs, Integer situacao) {

    }

    @Override
    public void editFreioTr(Integer codOs, Integer situacao) {

    }

    @Override
    public void editInj(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editLavacao(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editMotor(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editPneus(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editrevisão(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editStAviso(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editSuspensaoDt(Integer codOs, Integer situacao) {

    }

    @Override
    public void editSuspensaoTr(Integer codOs, Integer situacao) {

    }

    @Override
    public void edittrocaOleo(Integer codOs, Integer prof, Integer situacao) {

    }

    @Override
    public void editStgeralAtend(Integer codOs, Integer prof, Integer situacao) {
