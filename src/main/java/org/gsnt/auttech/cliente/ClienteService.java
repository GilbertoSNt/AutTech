...
public class ClienteService implements ClienteDao {
    ...
    @Override
    public List<Telefone> findTelById(int id) {
        return List.of();
    }
    ...
    @Override
    public Boolean telCliente(List<Telefone> telefone, int cod) {
        return null;
    }
    ...
    @Override
    public Boolean telAlterCliente(List<Telefone> telefone) {
        return null;
    }
    ...
    @Override
    public Boolean excluirTelCliente(Telefone telefone) {
        return null;
    }
